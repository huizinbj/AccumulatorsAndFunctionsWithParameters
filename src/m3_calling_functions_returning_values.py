...
def run_test_digits_in_cube():
    ...
    print()
    print('-----------------------------------------------------')
    print('Testing the   digits_in_cube   function#2:')
    print('-----------------------------------------------------')
    ...
    print()
    print('-----------------------------------------------------')
    print('Testing the   digits_in_cube   function#3:')
    print('-----------------------------------------------------')
...
def run_test_digits_in_power():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing the   digits_in_power   function#2:')
    print('--------------------------------------------------')
    ...
    print()
    print('--------------------------------------------------')
    print('Testing the   digits_in_power   function#3:')
    print('--------------------------------------------------')
...
def run_test_fancy_sums_of_digits():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing the   fancy_sums_of_digits   function#2:')
    print('--------------------------------------------------')
    ...
    print()
    print('--------------------------------------------------')
    print('Testing the   fancy_sums_of_digits   function#3:')
    print('--------------------------------------------------')
